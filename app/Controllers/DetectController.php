...
class DetectController extends Controller
{
    ...
    public function specificDetection($hostname, $cloudflare_ip)
    {
        ...
        $result = $database_controller->DatabaseStatus();
        ...
        echo "    [*] Method 1 : \e[1;36;40mChecking Guardiran DNS History Database (" . number_format($ip_db) . " Records)" . PHP_EOL . PHP_EOL;
        ...
        echo PHP_EOL . "    \e[1;31;40m[*] Method 2 : \e[1;36;40mChecking Guardiran SSL Certificate Database (" . number_format($ssl_db) . " Records)" . PHP_EOL;
        ...
        echo PHP_EOL . "    \e[1;31;40m[*] Method 4 : \e[1;36;40mCheck Sub domains" . PHP_EOL;

        sleep(1);

        $sub_domain = new SubDomainController($hostname);
        $sub_domain_check_result = $sub_domain->subDomainCheckUp($hostname);
        $sub_domain_check_connection_status = $XSPA->getConnectionStatus();

        if ($sub_domain_check_result != NULL && $sub_domain_check_result != "false") {


            $this->results['method_4'] = $sub_domain_check_result['server_ip'];
            $database_controller->infiniteDatabase($hostname, $sub_domain_check_result['server_ip'], $sub_domain_check_result['subdomain']);
